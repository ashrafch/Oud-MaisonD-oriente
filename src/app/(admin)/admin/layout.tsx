...
import { BadgePercent, BarChart3, Boxes, ClipboardList, FileText, Home, Layers3, Megaphone, Package, Settings, ShieldCheck, Tag, Truck, UsersRound } from 'lucide-react';
...
const operationalNav = [
  ...
  { href: '/admin/shipping', label: 'Spedizione', icon: Truck },
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ed]">
      <aside className="fixed inset-y-0 left-0 hidden w-64 flex-col border-r border-ink/10 bg-white p-5 lg:flex">
        <div>
          <p className="font-serif text-3xl">OUDE Admin</p>
      ...
      <header className="sticky top-0 z-40 border-b border-ink/10 bg-white lg:hidden">
        <div className="container py-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="font-serif text-2xl">OUDE Admin</p>
