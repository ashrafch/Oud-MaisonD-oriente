...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 rounded border border-ink/10 bg-white p-4 shadow-soft md:left-auto md:max-w-lg">
      ...
      <p className="mt-1 text-sm leading-6 text-ink/62">Usiamo cookie tecnici e predisposizione analytics/pixel. In produzione collega una CMP completa e aggiorna le policy legali.</p>
